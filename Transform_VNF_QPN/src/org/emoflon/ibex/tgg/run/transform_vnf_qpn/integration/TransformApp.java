...
import org.emoflon.ibex.tgg.run.transform_vnf_qpn._RegistrationHelper;
...
public class TransformApp extends SYNC {
	...
	private static IbexOptions createIbexOptions() {
		...
		return _RegistrationHelper.createIbexOptions().projectPath("platform:/plugin/Transform_VNF_QPN");
	}
